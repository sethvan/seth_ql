...
class InputCType : public SqlCType {
   public:
    InputCType( const char* _fieldName, enum_field_types type, void* _buffer,
                unsigned long long _bufferLength = 0 )
...
class TypeMysqlTimeInput : public InputCType {
   ...
   public:
    ...
    TypeMysqlTimeInput( const char* _fieldName, enum_field_types type )
        : InputCType( _fieldName, type, &value ) {
        if ( !isTimeType( type ) ) {
...
class TypeMysqlTimeOutput : public OutputCType {
   ...
   public:
    ...
    TypeMysqlTimeOutput( const char* _fieldName, enum_field_types type )
        : OutputCType( _fieldName, type, &value ) {
        if ( !isTimeType( type ) ) {
...
class TypeCharArrayInput : public InputCType {
   ...
   public:
    ...
    TypeCharArrayInput( const char* _fieldName, enum_field_types type,
...
class TypeCharArrayOutput : public OutputCType {
   ...
   public:
    ...
    TypeCharArrayOutput( const char* _fieldName, enum_field_types type,
                         unsigned long long _bufferLength )

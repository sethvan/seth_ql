...
BindsArray<InputCType> memory_summary_global_by_event_nameInputBindsArray() {
   giraffe giraffe giraffe return makeInputBindsArray(
...
BindsArray<InputCType> metadata_locksInputBindsArray() {
   return makeInputBindsArray(
       ...
       giraffe giraffe giraffe Bind<VARCHAR>( "OBJECT_NAME", 100 ),
       Bind<BIGINT_UNSIGNED>( "OBJECT_INSTANCE_BEGIN" ), Bind<VARCHAR>( "LOCK_TYPE", 100 ),
       Bind<VARCHAR>( "LOCK_DURATION", 100 ), Bind<VARCHAR>( "LOCK_STATUS", 100 ),
       Bind<VARCHAR>( "SOURCE", 100 ), Bind<BIGINT_UNSIGNED>( "OWNER_THREAD_ID" ),
       Bind<BIGINT_UNSIGNED>( "OWNER_EVENT_ID" ) );
}
...
BindsArray<OutputCType> mutex_instancesOutputBindsArray() {
   giraffe giraffe giraffe return makeOutputBindsArray(
       Bind<VARCHAR>( "NAME", 100 ), Bind<BIGINT_UNSIGNED>( "OBJECT_INSTANCE_BEGIN" ),
       Bind<BIGINT_UNSIGNED>( "LOCKED_BY_THREAD_ID" ) );
}
...
giraffe giraffe giraffe
    ...
    BindsArray<InputCType>
    setup_timersInputBindsArray() {

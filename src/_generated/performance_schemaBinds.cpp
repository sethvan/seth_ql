...
Binds<InputCType> accountsInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_SESSION_CONTROLLED_MEMORY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_SESSION_TOTAL_MEMORY") ));
}
Binds<OutputCType> accountsOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_SESSION_CONTROLLED_MEMORY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_SESSION_TOTAL_MEMORY") ));
}
...
Binds<InputCType> binary_log_transaction_compression_statsInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("TRANSACTION_COUNTER"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COMPRESSED_BYTES_COUNTER"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("UNCOMPRESSED_BYTES_COUNTER"),
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("FIRST_TRANSACTION_COMPRESSED_BYTES"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("FIRST_TRANSACTION_UNCOMPRESSED_BYTES"),
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("LAST_TRANSACTION_COMPRESSED_BYTES"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("LAST_TRANSACTION_UNCOMPRESSED_BYTES"),
        std::make_unique<TypeMysqlTimeInput>( "LAST_TRANSACTION_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ) ));
}
Binds<OutputCType> binary_log_transaction_compression_statsOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("TRANSACTION_COUNTER"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COMPRESSED_BYTES_COUNTER"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("UNCOMPRESSED_BYTES_COUNTER"),
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("FIRST_TRANSACTION_COMPRESSED_BYTES"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("FIRST_TRANSACTION_UNCOMPRESSED_BYTES"),
        std::make_unique<TypeMysqlTimeOutput>( "FIRST_TRANSACTION_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeCharArrayOutput>( "LAST_TRANSACTION_ID", MYSQL_TYPE_BLOB, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("LAST_TRANSACTION_COMPRESSED_BYTES"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("LAST_TRANSACTION_UNCOMPRESSED_BYTES"),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_TRANSACTION_TIMESTAMP", MYSQL_TYPE_TIMESTAMP) ));
}

Binds<InputCType> cond_instancesInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        std::make_unique<TypeCharArrayInput>( "NAME", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OBJECT_INSTANCE_BEGIN") ));
}
Binds<OutputCType> cond_instancesOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        std::make_unique<TypeCharArrayOutput>( "NAME", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OBJECT_INSTANCE_BEGIN") ));
}
...
Binds<InputCType> data_lock_waitsInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("REQUESTING_ENGINE_TRANSACTION_ID"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("REQUESTING_THREAD_ID"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("REQUESTING_EVENT_ID"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("REQUESTING_OBJECT_INSTANCE_BEGIN"),
        std::make_unique<TypeCharArrayInput>( "BLOCKING_ENGINE_LOCK_ID", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BLOCKING_ENGINE_TRANSACTION_ID"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BLOCKING_THREAD_ID"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BLOCKING_EVENT_ID"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BLOCKING_OBJECT_INSTANCE_BEGIN") ));
}
Binds<OutputCType> data_lock_waitsOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        std::make_unique<TypeCharArrayOutput>( "ENGINE", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeCharArrayOutput>( "REQUESTING_ENGINE_LOCK_ID", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("REQUESTING_ENGINE_TRANSACTION_ID"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("REQUESTING_THREAD_ID"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("REQUESTING_EVENT_ID"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("REQUESTING_OBJECT_INSTANCE_BEGIN"),
        std::make_unique<TypeCharArrayOutput>( "BLOCKING_ENGINE_LOCK_ID", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BLOCKING_ENGINE_TRANSACTION_ID"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BLOCKING_THREAD_ID"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BLOCKING_EVENT_ID"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BLOCKING_OBJECT_INSTANCE_BEGIN") ));
}
...
Binds<InputCType> data_locksInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("ENGINE_TRANSACTION_ID"),
...
Binds<OutputCType> data_locksOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("ENGINE_TRANSACTION_ID"),
...
Binds<InputCType> events_errors_summary_by_account_by_errorInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ERROR_RAISED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ERROR_HANDLED"),
...
Binds<OutputCType> events_errors_summary_by_account_by_errorOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ERROR_RAISED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ERROR_HANDLED"),
...
Binds<InputCType> events_stages_currentInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("WORK_COMPLETED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("WORK_ESTIMATED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NESTING_EVENT_ID"),
...
Binds<OutputCType> events_stages_currentOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("WORK_COMPLETED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("WORK_ESTIMATED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NESTING_EVENT_ID"),
...
Binds<InputCType> events_stages_summary_by_account_by_event_nameInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WAIT") ));
}
Binds<OutputCType> events_stages_summary_by_account_by_event_nameOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WAIT") ));
}
...
Binds<InputCType> events_statements_currentInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("CREATED_TMP_DISK_TABLES"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("CREATED_TMP_TABLES"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_FULL_JOIN"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_FULL_RANGE_JOIN"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_RANGE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_RANGE_CHECK"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_SCAN"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SORT_MERGE_PASSES"),
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NO_GOOD_INDEX_USED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NESTING_EVENT_ID"),
        std::make_unique<TypeCharArrayInput>( "NESTING_EVENT_TYPE", MYSQL_TYPE_STRING, 100 ),
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_CONTROLLED_MEMORY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TOTAL_MEMORY"),
...
Binds<OutputCType> events_statements_currentOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("ROWS_AFFECTED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("ROWS_SENT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("ROWS_EXAMINED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("CREATED_TMP_DISK_TABLES"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("CREATED_TMP_TABLES"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_FULL_JOIN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_FULL_RANGE_JOIN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_RANGE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_RANGE_CHECK"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SELECT_SCAN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SORT_MERGE_PASSES"),
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NO_INDEX_USED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NO_GOOD_INDEX_USED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NESTING_EVENT_ID"),
        std::make_unique<TypeCharArrayOutput>( "NESTING_EVENT_TYPE", MYSQL_TYPE_STRING, 100),
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_CONTROLLED_MEMORY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TOTAL_MEMORY"),
...
Binds<InputCType> events_statements_histogram_by_digestInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BUCKET_TIMER_LOW"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BUCKET_TIMER_HIGH"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_BUCKET"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_BUCKET_AND_LOWER"),
...
Binds<OutputCType> events_statements_histogram_by_digestOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BUCKET_TIMER_LOW"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("BUCKET_TIMER_HIGH"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_BUCKET"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_BUCKET_AND_LOWER"),
...
Binds<InputCType> events_statements_summary_by_account_by_event_nameInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_AFFECTED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_SENT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_EXAMINED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_CREATED_TMP_DISK_TABLES"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_CREATED_TMP_TABLES"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_FULL_JOIN"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_FULL_RANGE_JOIN"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_RANGE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_RANGE_CHECK"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_SCAN"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SORT_MERGE_PASSES"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SORT_RANGE"),
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NO_INDEX_USED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NO_GOOD_INDEX_USED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_CPU_TIME"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_CONTROLLED_MEMORY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TOTAL_MEMORY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_SECONDARY") ));
}
Binds<OutputCType> events_statements_summary_by_account_by_event_nameOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_LOCK_TIME"),
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_AFFECTED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_SENT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_EXAMINED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_CREATED_TMP_DISK_TABLES"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_CREATED_TMP_TABLES"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_FULL_JOIN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_FULL_RANGE_JOIN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_RANGE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_RANGE_CHECK"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SELECT_SCAN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SORT_MERGE_PASSES"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SORT_RANGE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SORT_ROWS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_SORT_SCAN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NO_INDEX_USED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NO_GOOD_INDEX_USED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_CPU_TIME"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_CONTROLLED_MEMORY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TOTAL_MEMORY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_SECONDARY") ));
}
...
Binds<InputCType> events_statements_summary_by_digestInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("QUERY_SAMPLE_TIMER_WAIT") ));
}
Binds<OutputCType> events_statements_summary_by_digestOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("QUERY_SAMPLE_TIMER_WAIT") ));
}
...
Binds<InputCType> events_statements_summary_by_programInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_STATEMENTS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_STATEMENTS_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_STATEMENTS_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_STATEMENTS_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_STATEMENTS_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_LOCK_TIME"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ERRORS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_WARNINGS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_AFFECTED"),
...
Binds<OutputCType> events_statements_summary_by_programOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_STATEMENTS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_STATEMENTS_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_STATEMENTS_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_STATEMENTS_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_STATEMENTS_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_LOCK_TIME"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ERRORS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_WARNINGS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_AFFECTED"),
...
Binds<InputCType> events_transactions_currentInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NUMBER_OF_SAVEPOINTS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NUMBER_OF_ROLLBACK_TO_SAVEPOINT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NUMBER_OF_RELEASE_SAVEPOINT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OBJECT_INSTANCE_BEGIN"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NESTING_EVENT_ID"),
        std::make_unique<TypeCharArrayInput>( "NESTING_EVENT_TYPE", MYSQL_TYPE_STRING, 100 ) ));
}
Binds<OutputCType> events_transactions_currentOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NUMBER_OF_SAVEPOINTS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NUMBER_OF_ROLLBACK_TO_SAVEPOINT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NUMBER_OF_RELEASE_SAVEPOINT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OBJECT_INSTANCE_BEGIN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("NESTING_EVENT_ID"),
        std::make_unique<TypeCharArrayOutput>( "NESTING_EVENT_TYPE", MYSQL_TYPE_STRING, 100) ));
}
...
Binds<InputCType> events_transactions_summary_by_account_by_event_nameInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WAIT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_ONLY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_ONLY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_ONLY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_ONLY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_ONLY") ));
}
Binds<OutputCType> events_transactions_summary_by_account_by_event_nameOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WAIT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_ONLY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_ONLY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_ONLY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_ONLY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_ONLY") ));
}
...
Binds<InputCType> file_summary_by_event_nameInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_READ"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_MISC"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_MISC"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_MISC"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_MISC"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_MISC") ));
}
Binds<OutputCType> file_summary_by_event_nameOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_READ"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_MISC"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_MISC"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_MISC"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_MISC"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_MISC") ));
}
...
Binds<InputCType> host_cacheInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_HOST_BLOCKED_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_NAMEINFO_TRANSIENT_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_NAMEINFO_PERMANENT_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_FORMAT_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_ADDRINFO_TRANSIENT_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_ADDRINFO_PERMANENT_ERRORS"),
        ...
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_NO_AUTH_PLUGIN_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_AUTH_PLUGIN_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_HANDSHAKE_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_PROXY_USER_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_PROXY_USER_ACL_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_AUTHENTICATION_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_SSL_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_MAX_USER_CONNECTIONS_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_MAX_USER_CONNECTIONS_PER_HOUR_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_DEFAULT_DATABASE_ERRORS"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_INIT_CONNECT_ERRORS"),
...
Binds<OutputCType> host_cacheOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_HOST_BLOCKED_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_NAMEINFO_TRANSIENT_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_NAMEINFO_PERMANENT_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_FORMAT_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_ADDRINFO_TRANSIENT_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_ADDRINFO_PERMANENT_ERRORS"),
        ...
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_NO_AUTH_PLUGIN_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_AUTH_PLUGIN_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_HANDSHAKE_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_PROXY_USER_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_PROXY_USER_ACL_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_AUTHENTICATION_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_SSL_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_MAX_USER_CONNECTIONS_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_MAX_USER_CONNECTIONS_PER_HOUR_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_DEFAULT_DATABASE_ERRORS"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("COUNT_INIT_CONNECT_ERRORS"),
...
Binds<InputCType> memory_summary_by_account_by_event_nameInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_ALLOC"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_FREE"),
        ...
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("LOW_NUMBER_OF_BYTES_USED"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("CURRENT_NUMBER_OF_BYTES_USED"),
        std::make_unique<TypeInputImpl<long long, MYSQL_TYPE_LONGLONG>>("HIGH_NUMBER_OF_BYTES_USED") ));
}
Binds<OutputCType> memory_summary_by_account_by_event_nameOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_ALLOC"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_FREE"),
        ...
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("LOW_NUMBER_OF_BYTES_USED"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("CURRENT_NUMBER_OF_BYTES_USED"),
        std::make_unique<TypeOutputImpl<long long, MYSQL_TYPE_LONGLONG>>("HIGH_NUMBER_OF_BYTES_USED") ));
}
...
Binds<InputCType> metadata_locksInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeCharArrayInput>( "LOCK_STATUS", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeCharArrayInput>( "SOURCE", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OWNER_THREAD_ID"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OWNER_EVENT_ID") ));
}
Binds<OutputCType> metadata_locksOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeCharArrayOutput>( "LOCK_STATUS", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeCharArrayOutput>( "SOURCE", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OWNER_THREAD_ID"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OWNER_EVENT_ID") ));
}
...
Binds<InputCType> mutex_instancesInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        std::make_unique<TypeCharArrayInput>( "NAME", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OBJECT_INSTANCE_BEGIN"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("LOCKED_BY_THREAD_ID") ));
}
Binds<OutputCType> mutex_instancesOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        std::make_unique<TypeCharArrayOutput>( "NAME", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OBJECT_INSTANCE_BEGIN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("LOCKED_BY_THREAD_ID") ));
}
...
Binds<InputCType> prepared_statements_instancesInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_REPREPARE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_EXECUTE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_EXECUTE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_EXECUTE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_EXECUTE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_EXECUTE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_LOCK_TIME"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ERRORS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_WARNINGS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_AFFECTED"),
...
Binds<OutputCType> prepared_statements_instancesOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeCharArrayOutput>( "EXECUTION_ENGINE", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("TIMER_PREPARE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_REPREPARE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_EXECUTE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_EXECUTE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_EXECUTE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_EXECUTE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_EXECUTE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_LOCK_TIME"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ERRORS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_WARNINGS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_ROWS_AFFECTED"),
...
Binds<InputCType> replication_applier_configurationInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeCharArrayInput>( "REQUIRE_TABLE_PRIMARY_KEY_CHECK", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeCharArrayInput>( "ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_TYPE", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeCharArrayInput>( "ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_VALUE", MYSQL_TYPE_STRING, 100 ) ));
}
Binds<OutputCType> replication_applier_configurationOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeCharArrayOutput>( "REQUIRE_TABLE_PRIMARY_KEY_CHECK", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeCharArrayOutput>( "ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_TYPE", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeCharArrayOutput>( "ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_VALUE", MYSQL_TYPE_BLOB, 100) ));
}
...
Binds<InputCType> replication_applier_statusInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_RETRIES") ));
}
Binds<OutputCType> replication_applier_statusOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_RETRIES") ));
}
...
Binds<InputCType> replication_applier_status_by_coordinatorInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeCharArrayInput>( "LAST_PROCESSED_TRANSACTION", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_PROCESSED_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_PROCESSED_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_PROCESSED_TRANSACTION_START_BUFFER_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_PROCESSED_TRANSACTION_END_BUFFER_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeCharArrayInput>( "PROCESSING_TRANSACTION", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeMysqlTimeInput>( "PROCESSING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "PROCESSING_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "PROCESSING_TRANSACTION_START_BUFFER_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ) ));
}
Binds<OutputCType> replication_applier_status_by_coordinatorOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeCharArrayOutput>( "LAST_PROCESSED_TRANSACTION", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_PROCESSED_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_PROCESSED_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_PROCESSED_TRANSACTION_START_BUFFER_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_PROCESSED_TRANSACTION_END_BUFFER_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeCharArrayOutput>( "PROCESSING_TRANSACTION", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeMysqlTimeOutput>( "PROCESSING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "PROCESSING_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "PROCESSING_TRANSACTION_START_BUFFER_TIMESTAMP", MYSQL_TYPE_TIMESTAMP) ));
}
...
Binds<InputCType> replication_applier_status_by_workerInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeMysqlTimeInput>( "LAST_APPLIED_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_APPLIED_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_APPLIED_TRANSACTION_START_APPLY_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_APPLIED_TRANSACTION_END_APPLY_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeCharArrayInput>( "APPLYING_TRANSACTION", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeMysqlTimeInput>( "APPLYING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "APPLYING_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "APPLYING_TRANSACTION_START_APPLY_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("LAST_APPLIED_TRANSACTION_RETRIES_COUNT"),
        std::make_unique<TypeInputImpl<int, MYSQL_TYPE_LONG>>("LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER"),
        std::make_unique<TypeCharArrayInput>( "LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("APPLYING_TRANSACTION_RETRIES_COUNT"),
        std::make_unique<TypeInputImpl<int, MYSQL_TYPE_LONG>>("APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER"),
        std::make_unique<TypeCharArrayInput>( "APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeMysqlTimeInput>( "APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ) ));
}
Binds<OutputCType> replication_applier_status_by_workerOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeMysqlTimeOutput>( "LAST_APPLIED_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_APPLIED_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_APPLIED_TRANSACTION_START_APPLY_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_APPLIED_TRANSACTION_END_APPLY_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeCharArrayOutput>( "APPLYING_TRANSACTION", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeMysqlTimeOutput>( "APPLYING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "APPLYING_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "APPLYING_TRANSACTION_START_APPLY_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("LAST_APPLIED_TRANSACTION_RETRIES_COUNT"),
        std::make_unique<TypeOutputImpl<int, MYSQL_TYPE_LONG>>("LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER"),
        std::make_unique<TypeCharArrayOutput>( "LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_APPLIED_TRANSACTION_LAST_TRANSIENT_ERROR_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("APPLYING_TRANSACTION_RETRIES_COUNT"),
        std::make_unique<TypeOutputImpl<int, MYSQL_TYPE_LONG>>("APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_NUMBER"),
        std::make_unique<TypeCharArrayOutput>( "APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_MESSAGE", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeMysqlTimeOutput>( "APPLYING_TRANSACTION_LAST_TRANSIENT_ERROR_TIMESTAMP", MYSQL_TYPE_TIMESTAMP) ));
}
...
Binds<InputCType> replication_asynchronous_connection_failoverInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned int, MYSQL_TYPE_LONG>>("WEIGHT"),
...
Binds<OutputCType> replication_asynchronous_connection_failoverOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned int, MYSQL_TYPE_LONG>>("WEIGHT"),
...
Binds<InputCType> replication_connection_configurationInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeCharArrayInput>( "SSL_VERIFY_SERVER_CERTIFICATE", MYSQL_TYPE_STRING, 100 ),
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("CONNECTION_RETRY_COUNT"),
        ...
        std::make_unique<TypeCharArrayInput>( "SOURCE_CONNECTION_AUTO_FAILOVER", MYSQL_TYPE_STRING, 100 ),
...
Binds<OutputCType> replication_connection_configurationOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeCharArrayOutput>( "SSL_VERIFY_SERVER_CERTIFICATE", MYSQL_TYPE_STRING, 100),
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("CONNECTION_RETRY_COUNT"),
        ...
        std::make_unique<TypeCharArrayOutput>( "SOURCE_CONNECTION_AUTO_FAILOVER", MYSQL_TYPE_STRING, 100),
...
Binds<InputCType> replication_connection_statusInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("THREAD_ID"),
        std::make_unique<TypeCharArrayInput>( "SERVICE_STATE", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_RECEIVED_HEARTBEATS"),
        ...
        std::make_unique<TypeMysqlTimeInput>( "LAST_QUEUED_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_QUEUED_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_QUEUED_TRANSACTION_START_QUEUE_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "LAST_QUEUED_TRANSACTION_END_QUEUE_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeCharArrayInput>( "QUEUEING_TRANSACTION", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeMysqlTimeInput>( "QUEUEING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "QUEUEING_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ),
        std::make_unique<TypeMysqlTimeInput>( "QUEUEING_TRANSACTION_START_QUEUE_TIMESTAMP", MYSQL_TYPE_TIMESTAMP ) ));
}
Binds<OutputCType> replication_connection_statusOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("THREAD_ID"),
        std::make_unique<TypeCharArrayOutput>( "SERVICE_STATE", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_RECEIVED_HEARTBEATS"),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_HEARTBEAT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeCharArrayOutput>( "RECEIVED_TRANSACTION_SET", MYSQL_TYPE_MEDIUM_BLOB, 100),
        std::make_unique<TypeOutputImpl<int, MYSQL_TYPE_LONG>>("LAST_ERROR_NUMBER"),
        std::make_unique<TypeCharArrayOutput>( "LAST_ERROR_MESSAGE", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_ERROR_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeCharArrayOutput>( "LAST_QUEUED_TRANSACTION", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_QUEUED_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_QUEUED_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_QUEUED_TRANSACTION_START_QUEUE_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "LAST_QUEUED_TRANSACTION_END_QUEUE_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeCharArrayOutput>( "QUEUEING_TRANSACTION", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeMysqlTimeOutput>( "QUEUEING_TRANSACTION_ORIGINAL_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "QUEUEING_TRANSACTION_IMMEDIATE_COMMIT_TIMESTAMP", MYSQL_TYPE_TIMESTAMP),
        std::make_unique<TypeMysqlTimeOutput>( "QUEUEING_TRANSACTION_START_QUEUE_TIMESTAMP", MYSQL_TYPE_TIMESTAMP) ));
}
...
Binds<InputCType> replication_group_member_statsInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_IN_QUEUE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_CHECKED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_CONFLICTS_DETECTED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_ROWS_VALIDATING"),
        std::make_unique<TypeCharArrayInput>( "TRANSACTIONS_COMMITTED_ALL_MEMBERS", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeCharArrayInput>( "LAST_CONFLICT_FREE_TRANSACTION", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_REMOTE_IN_APPLIER_QUEUE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_REMOTE_APPLIED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_LOCAL_PROPOSED"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_LOCAL_ROLLBACK") ));
}
Binds<OutputCType> replication_group_member_statsOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_IN_QUEUE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_CHECKED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_CONFLICTS_DETECTED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_ROWS_VALIDATING"),
        std::make_unique<TypeCharArrayOutput>( "TRANSACTIONS_COMMITTED_ALL_MEMBERS", MYSQL_TYPE_MEDIUM_BLOB, 100),
        std::make_unique<TypeCharArrayOutput>( "LAST_CONFLICT_FREE_TRANSACTION", MYSQL_TYPE_BLOB, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_REMOTE_IN_APPLIER_QUEUE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_REMOTE_APPLIED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_LOCAL_PROPOSED"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_TRANSACTIONS_LOCAL_ROLLBACK") ));
}
...
Binds<InputCType> replication_group_membersInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeCharArrayInput>( "MEMBER_COMMUNICATION_STACK", MYSQL_TYPE_STRING, 100 ) ));
}
Binds<OutputCType> replication_group_membersOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeCharArrayOutput>( "MEMBER_COMMUNICATION_STACK", MYSQL_TYPE_STRING, 100) ));
}
...
Binds<InputCType> rwlock_instancesInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        std::make_unique<TypeCharArrayInput>( "NAME", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OBJECT_INSTANCE_BEGIN"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("WRITE_LOCKED_BY_THREAD_ID"),
        std::make_unique<TypeInputImpl<unsigned int, MYSQL_TYPE_LONG>>("READ_LOCKED_BY_COUNT") ));
}
Binds<OutputCType> rwlock_instancesOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        std::make_unique<TypeCharArrayOutput>( "NAME", MYSQL_TYPE_VAR_STRING, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("OBJECT_INSTANCE_BEGIN"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("WRITE_LOCKED_BY_THREAD_ID"),
        std::make_unique<TypeOutputImpl<unsigned int, MYSQL_TYPE_LONG>>("READ_LOCKED_BY_COUNT") ));
}

Binds<InputCType> session_account_connect_attrsInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("PROCESSLIST_ID"),
...
Binds<OutputCType> session_account_connect_attrsOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("PROCESSLIST_ID"),
...
Binds<InputCType> socket_summary_by_event_nameInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_READ"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_MISC"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_MISC"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_MISC"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_MISC"),
...
Binds<OutputCType> socket_summary_by_event_nameOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_READ"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_NUMBER_OF_BYTES_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_MISC"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_MISC"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_MISC"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_MISC"),
...
Binds<InputCType> table_io_waits_summary_by_index_usageInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_FETCH"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_FETCH"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_FETCH"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_FETCH"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_UPDATE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_UPDATE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_UPDATE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_UPDATE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_UPDATE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_DELETE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_DELETE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_DELETE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_DELETE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_DELETE") ));
}
Binds<OutputCType> table_io_waits_summary_by_index_usageOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_FETCH"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_FETCH"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_FETCH"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_FETCH"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_UPDATE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_UPDATE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_UPDATE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_UPDATE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_UPDATE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_DELETE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_DELETE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_DELETE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_DELETE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_DELETE") ));
}
...
Binds<InputCType> table_lock_waits_summary_by_tableInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_HIGH_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_HIGH_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_HIGH_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_HIGH_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_HIGH_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_NO_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_NO_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_NO_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_NO_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_NO_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_EXTERNAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_EXTERNAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_EXTERNAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_EXTERNAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_EXTERNAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_NORMAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_EXTERNAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_EXTERNAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_EXTERNAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_EXTERNAL"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_EXTERNAL") ));
}
Binds<OutputCType> table_lock_waits_summary_by_tableOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_WITH_SHARED_LOCKS"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_HIGH_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_HIGH_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_HIGH_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_HIGH_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_HIGH_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_NO_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_NO_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_NO_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_NO_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_NO_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_READ_EXTERNAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_READ_EXTERNAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_READ_EXTERNAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_READ_EXTERNAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_READ_EXTERNAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_ALLOW_WRITE"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_CONCURRENT_INSERT"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_LOW_PRIORITY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_NORMAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("COUNT_WRITE_EXTERNAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("SUM_TIMER_WRITE_EXTERNAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MIN_TIMER_WRITE_EXTERNAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("AVG_TIMER_WRITE_EXTERNAL"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_TIMER_WRITE_EXTERNAL") ));
}
...
Binds<InputCType> threadsInputBinds(){
    return Binds<InputCType>( make_vector<InputCType>( 
        ...
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("PARENT_THREAD_ID"),
        std::make_unique<TypeCharArrayInput>( "ROLE", MYSQL_TYPE_STRING, 100 ),
        ...
        std::make_unique<TypeCharArrayInput>( "EXECUTION_ENGINE", MYSQL_TYPE_STRING, 100 ),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("CONTROLLED_MEMORY"),
        std::make_unique<TypeInputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_CONTROLLED_MEMORY"),
...
Binds<OutputCType> threadsOutputBinds(){
    return Binds<OutputCType>( make_vector<OutputCType>( 
        ...
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("PARENT_THREAD_ID"),
        ...
        std::make_unique<TypeCharArrayOutput>( "EXECUTION_ENGINE", MYSQL_TYPE_STRING, 100),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("CONTROLLED_MEMORY"),
        std::make_unique<TypeOutputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>("MAX_CONTROLLED_MEMORY"),
